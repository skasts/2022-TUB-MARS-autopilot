// This script can be used for Arduinos with servo motors connected via a simpler motor driver like
// L298. This script is not maintained though and does not have code documentation
